...
static int QRinput_checkModeFNC1Second(int size, const unsigned char *data __attribute__((unused)))
{
...
static int QRinput_encodeModeFNC1Second(QRinput_List *entry, int version __attribute__((unused)))
{
        int ret;
...
static int QRinput_encodeModeECI(QRinput_List *entry, int version __attribute__((unused)))
{
        int ret, words;
